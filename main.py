...
def generate_invoice():
    ...
    salestax = subtotal *(0.18/100)  #sales tax is 10%
    ...
    doc_name = "INVOICE " + name + datetime.datetime.now().strftime("%Y-%m-%d-%H%M%S") + ".docx"
    doc.save(doc_name)
...
gst_label = tkinter.Label(frame, text="GSTIN")
gst_label.grid(row = 0, column = 1)
